...
export default function MarketChart({ coinsData }) {
  ...
  const coinRangePriceQuery: any = useCoinRangePrice(ActiveCoin, DayRange, ActiveCurrency);
    ...
    <Box className="flex flex-resp jcsb" sx={{ mb: 1 }}>
      ...
      <Box className="flex-center-y" sx={{ mt: 1 }}>
        ...
        <ButtonGroup id='dayRange' variant="contained" disableElevation aria-label="outlined primary button group" sx={{ ml: 1 }}>
          <Button onClick={() => setDayRange(1)} color={DayRange === 1 ? "info" : "inherit"}>24h</Button>
          <Button onClick={() => setDayRange(7)} color={DayRange === 7 ? "info" : "inherit"}>7d</Button>
          <Button onClick={() => setDayRange(14)} color={DayRange === 14 ? "info" : "inherit"}>14d</Button>
          <Button onClick={() => setDayRange(30)} color={DayRange === 30 ? "info" : "inherit"}>30d</Button>
          <Button onClick={() => setDayRange(90)} color={DayRange === 90 ? "info" : "inherit"}>90d</Button>
        </ButtonGroup>
      </Box>
